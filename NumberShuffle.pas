...
type
  TForm1 = class(TForm)
    ...
    procedure SolutionChecker(); //cltr+shift+c
    procedure Sorting();
...
procedure TForm1.btnNum10Click(Sender: TObject);
begin
...
procedure TForm1.btnNum11Click(Sender: TObject);
begin
...
procedure TForm1.btnNum12Click(Sender: TObject);
begin
...
procedure TForm1.EmptySpotChecker(Butt1: TButton; Butt2: TButton);
begin
...
procedure TForm1.SolutionChecker;
begin
